...
export default function ScrollMinumanRasa({ produk, onAddToCart }) {
  ...
  return (
    <View>
      <Text style={GlobalStyle.textStyle}>Minuman Rasa</Text>
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        {produk
          .filter((product) => product.jns_produk === "minuman varian rasa")
          .map((product, i) => (
            <Card
              key={i}
